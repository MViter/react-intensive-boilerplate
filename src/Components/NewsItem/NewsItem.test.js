...
const someInstance = new NewsItem();
someInstance.getPublishedTimeInCorrectFormat

Enzyme.configure({ adapter: new Adapter() });
const handleFunctionMock = jest.fn();

//const wrap = mount(<NewsItem searchCriteria = 'abc' handleSearchInput = { handleFunctionMock } />);
